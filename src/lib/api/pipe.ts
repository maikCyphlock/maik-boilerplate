...
export async function runPipeline<T, B>(
  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      const cause = error.cause as { code?: string; validationErrors?: unknown } | undefined;
      ...
      if (cause?.validationErrors) responseData.validationErrors = cause.validationErrors;
